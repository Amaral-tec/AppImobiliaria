    ...
    <div class="col-lg-4 col-md-6 mix all house">
        <div class="property-item">
            ...
            <div class="pi-text">
                ...
                <h5><a href="property-details.jsp">Residencial Thisaliah</a></h5>
    ...
    <div class="col-lg-4 col-md-6 mix all restaurent hotel">
        <div class="property-item">
            ...
            <div class="pi-text">
                ...
                <div class="pt-price">R$ 120.000,00</div>
                <h5><a href="#">Loteamento São Paulo</a></h5>
                <p><span class="icon_pin_alt"></span> Parnamirim, Rio Grande do Norte</p>
                <ul>
                    <li><i class="fa fa-object-group"></i> 2, 283</li>
                    <li><i class="fa fa-bathtub"></i> 03</li>
                    <li><i class="fa fa-bed"></i> 05</li>
